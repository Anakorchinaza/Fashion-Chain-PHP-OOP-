...
<body style="background-color:white ;">
    ...
    <div class="row mt-32">
        <div class="col-md-12 mt-4" id="head2">
     ...
     <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="post_index.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              POST
            </a>
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="post_index.php">All Post</a></li>
              <li><a class="dropdown-item" href="post_profile.php">My Post</a></li>
