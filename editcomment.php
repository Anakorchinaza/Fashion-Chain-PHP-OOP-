<?php
   ...
   if (isset($_REQUEST['commentid'])) {
    $userscomment = $object->getComment($_REQUEST['commentid']);
   }
...
if (isset($_REQUEST['btncomment'])) {
 ...
 if (empty($error)) {
    ...
    $comments = $obj3->updateComment($content, $commentid);
    ...
    if ($comments == 'success') {
        # redirect
        $msg = 'success';
        header("Location: editcomment.php?msg=$msg");
        exit();
    }else{
        $error[] = $comments;
    }
    ...
    <div class="row bg-light">
        ...
        ?>
            ...
            <div class="col-md-9">
                ...
                <form action="editcomment.php?postid=<?php echo $value['post_id'] ?>" method="post">
                                                
                    <input type="text" name="comment" id="" placeholder="Post a comment" class="form-control mb-4" value="<?php 
                    if (isset($userscomment['comment'])) {
                        echo $userscomment['comment'];
                    }
                    ?>">
